...
class Random(BaseCommand):
    ...
    def __init__(self):
        ...
        # Parameters will be separated by spaces and fed into the 'params' argument in the handle() method
        # If no parameters are expected, leave this list empty or set it to None
        params = ["lower", "upper"]
    ...
    async def handle(self, params, message, client):
        # 'params' is a list that contains the parameters that the command expects to receive
        # It is guaranteed to have AT LEAST as many parameters as specified in __init__
